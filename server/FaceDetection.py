...
def face(image):
    ...
    if len(faces) == 0:
        ...
        print("1. Fitment Score : ", fitmentScore)
        return ["More than one Face Detected", fitmentScore]
...
def pose(image, grayImage, colorImage, fitmentScore):
    ...
    for face in faces:
        ...
        gaze = "Looking: "
        if angles[1] < -15:
            fitmentScore = fitmentScore-10
            print("Looking Left")
            print("6. Fitment Score : ", fitmentScore)
            return ["Looking Left", fitmentScore]
        elif angles[1] > 15:
            fitmentScore = fitmentScore-10
            print("Looking Right")
            print("6. Fitment Score : ", fitmentScore)
            return ["Looking Right", fitmentScore]
        else:
            fitmentScore = fitmentScore+20
